...
public class Polygon {
    ...
    private void partition() {
        partitioner.partitionPolygon();
//        System.out.println(Arrays.toString(partitioner.concaveVerts));
//        System.out.println(Arrays.toString(partitioner.partitionMap));
    }
